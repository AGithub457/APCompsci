...
package java.assignments.semester1.DrawAsteriskShapesPlus;
...
public class CoreParams {
    ...
    public void drawShape(ShapeChoice shapeChoice) {
        ...
        switch (shapeChoice) {
            case triangle: drawer = new ShapeTriangle(); break;
            case invertedTriangle: new ShapeTriangleInverted(); break;
            case equilateralTriangle: new ShapeTriangleEquilateral(); break;
            case invertedEquilateralTriangle: new ShapeTriangleEquilateralInverted(); break;
            case diamond: new ShapeDiamond(); break;
            case variableHeightDiamond: new ShapeDiamondVariableHeight(); break;
        }
